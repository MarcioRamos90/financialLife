...
func (r *AccountRepository) Balance(ctx context.Context, id, householdID string) (*model.AccountBalanceResponse, error) {
	...
	// Transfers in (destination account)
	res.Total = 0
	r.db.WithContext(ctx).Model(&model.Transaction{}).
